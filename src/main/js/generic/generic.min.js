 ...
 */
!function (t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).flatgeobuf = {})
}(this, (function (t) {
    "use strict";
    const e = new Int32Array(2), r = new Float32Array(e.buffer), n = new Float64Array(e.buffer),
        s = 1 === new Uint16Array(new Uint8Array([1, 0]).buffer)[0];
    ...
    class i {
        ...
        static create(t, e) {
            return 0 == t && 0 == e ? i.ZERO : new i(t, e)
        }
    ...
    class a {
        ...
        readInt64(t) {
            return new i(this.readInt32(t), this.readInt32(t + 4))
        }

        readUint64(t) {
            return new i(this.readUint32(t), this.readUint32(t + 4))
        }

        readFloat32(t) {
            return e[0] = this.readInt32(t), r[0]
        }

        readFloat64(t) {
            return e[s ? 0 : 1] = this.readInt32(t), e[s ? 1 : 0] = this.readInt32(t + 4), n[0]
        }
        ...
        writeFloat32(t, n) {
            r[0] = n, this.writeInt32(t, e[0])
        }

        writeFloat64(t, r) {
            n[0] = r, this.writeInt32(t, e[s ? 0 : 1]), this.writeInt32(t + 4, e[s ? 1 : 0])
        }
        ...
        __string(t, e) {
            ...
            let n = "", s = 0;
            if (t += 4, e === o.UTF8_BYTES) return this.bytes_.subarray(t, t + r);
            for (; s < r;) {
                let e;
    ...
    class h {
        constructor(t) {
            let e;
            this.minalign = 1, this.vtable = null, this.vtable_in_use = 0, this.isNested = !1, this.object_start = 0, this.vtables = [], this.vector_num_elems = 0, this.force_defaults = !1, this.string_maps = null, e = t || 1024, this.bb = a.allocate(e), this.space = e
        }
        ...
        prep(t, e) {
            ...
            for (; this.space < r + t + e;) {
                ...
                this.bb = h.growByteBuffer(this.bb), this.space += this.bb.capacity() - t
            }
            this.pad(r)
        }
    ...
    function f(t) {
        this._source = t, this._array = l, this._index = 0
    }

    f.prototype.read = function () {
        var t = this, e = t._array.subarray(t._index);
        return t._source.read().then((function (r) {
            return t._array = l, t._index = 0, r.done ? e.length > 0 ? {done: !1, value: e} : {
                done: !0,
                value: void 0
            } : {done: !1, value: b(e, r.value)}
        }))
    }, f.prototype.slice = function (t) {
        ...
        return n.set(this._array.subarray(this._index)), function s() {
            return e._source.read().then((function (i) {
                return i.done ? (e._array = l, e._index = 0, r > 0 ? n.subarray(0, r) : null) : r + i.value.length >= t ? (e._array = i.value, e._index = t - r, n.set(i.value.subarray(0, t - r), r), n) : (n.set(i.value, r), r += i.value.length, s())
            }))
        }()
    ...
    t.ColumnType = void 0, (u = t.ColumnType || (t.ColumnType = {}))[u.Byte = 0] = "Byte", u[u.UByte = 1] = "UByte", u[u.Bool = 2] = "Bool", u[u.Short = 3] = "Short", u[u.UShort = 4] = "UShort", u[u.Int = 5] = "Int", u[u.UInt = 6] = "UInt", u[u.Long = 7] = "Long", u[u.ULong = 8] = "ULong", u[u.Float = 9] = "Float", u[u.Double = 10] = "Double", u[u.String = 11] = "String", u[u.Json = 12] = "Json", u[u.DateTime = 13] = "DateTime", u[u.Binary = 14] = "Binary";
    ...
    class _ {
        ...
        type() {
            ...
            return e ? this.bb.readUint8(this.bb_pos + e) : t.ColumnType.Byte
        }
        ...
        static addType(e, r) {
            e.addFieldInt8(1, r, t.ColumnType.Byte)
        }
        ...
        static createColumn(t, e, r, n, s, i, o, a, h, u, c, l) {
            return _.startColumn(t), _.addName(t, e), _.addType(t, r), _.addTitle(t, n), _.addDescription(t, s), _.addWidth(t, i), _.addPrecision(t, o), _.addScale(t, a), _.addNullable(t, h), _.addUnique(t, u), _.addPrimaryKey(t, c), _.addMetadata(t, l), _.endColumn(t)
        }
    }
    ...
    class p {
        ...
        static createCrs(t, e, r, n, s, i, o) {
            return p.startCrs(t), p.addOrg(t, e), p.addCode(t, r), p.addName(t, n), p.addDescription(t, s), p.addWkt(t, i), p.addCodeString(t, o), p.endCrs(t)
        }
    }

    t.GeometryType = void 0, (c = t.GeometryType || (t.GeometryType = {}))[c.Unknown = 0] = "Unknown", c[c.Point = 1] = "Point", c[c.LineString = 2] = "LineString", c[c.Polygon = 3] = "Polygon", c[c.MultiPoint = 4] = "MultiPoint", c[c.MultiLineString = 5] = "MultiLineString", c[c.MultiPolygon = 6] = "MultiPolygon", c[c.GeometryCollection = 7] = "GeometryCollection", c[c.CircularString = 8] = "CircularString", c[c.CompoundCurve = 9] = "CompoundCurve", c[c.CurvePolygon = 10] = "CurvePolygon", c[c.MultiCurve = 11] = "MultiCurve", c[c.MultiSurface = 12] = "MultiSurface", c[c.Curve = 13] = "Curve", c[c.Surface = 14] = "Surface", c[c.PolyhedralSurface = 15] = "PolyhedralSurface", c[c.TIN = 16] = "TIN", c[c.Triangle = 17] = "Triangle";
    ...
    class y {
        ...
        static getSizePrefixedRootAsHeader(t, e) {
            return t.setPosition(t.position() + 4), (e || new y).__init(t.readInt32(t.position()) + t.position(), t)
        }
        ...
        geometryType() {
            const e = this.bb.__offset(this.bb_pos, 8);
            return e ? this.bb.readUint8(this.bb_pos + e) : t.GeometryType.Unknown
        }
        ...
        columns(t, e) {
            ...
            return r ? (e || new _).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : null
        }
        ...
        static addGeometryType(e, r) {
            e.addFieldInt8(2, r, t.GeometryType.Unknown)
        }
    ...
    class g {
        ...
        static getSizePrefixedRootAsGeometry(t, e) {
            return t.setPosition(t.position() + 4), (e || new g).__init(t.readInt32(t.position()) + t.position(), t)
        }
        ...
        parts(t, e) {
            const r = this.bb.__offset(this.bb_pos, 18);
            return r ? (e || new g).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : null
        }
        ...
        static addType(e, r) {
            e.addFieldInt8(6, r, t.GeometryType.Unknown)
        }
        ...
        static createGeometry(t, e, r, n, s, i, o, a, h) {
            return g.startGeometry(t), g.addEnds(t, e), g.addXy(t, r), g.addZ(t, n), g.addM(t, s), g.addT(t, i), g.addTm(t, o), g.addType(t, a), g.addParts(t, h), g.endGeometry(t)
        }
    }
    ...
    class w {
        ...
        static getSizePrefixedRootAsFeature(t, e) {
            return t.setPosition(t.position() + 4), (e || new w).__init(t.readInt32(t.position()) + t.position(), t)
        }

        geometry(t) {
            const e = this.bb.__offset(this.bb_pos, 4);
            return e ? (t || new g).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : null
        }
        ...
        static createFeature(t, e, r, n) {
            return w.startFeature(t), w.addGeometry(t, e), w.addProperties(t, r), w.addColumns(t, n), w.endFeature(t)
        }
    }
    ...
    class v {
        ...
        static fromByteBuffer(t) {
            const e = y.getRootAsHeader(t), r = e.featuresCount().toFloat64(), n = e.indexNodeSize(), s = [];
            for (let t = 0; t < e.columnsLength(); t++) {
                ...
                s.push(new d(r.name(), r.type(), r.title(), r.description(), r.width(), r.precision(), r.scale(), r.nullable(), r.unique(), r.primaryKey()))
            }
            const i = e.crs(),
                o = i ? new m(i.org(), i.code(), i.name(), i.description(), i.wkt(), i.codeString()) : null;
            return new v(e.geometryType(), s, r, n, o, e.title(), e.description(), e.metadata())
        }
    }
    ...
    function I(t, e) {
        ...
        if (i) {
            const e = i.map((e => I(t, e))), r = g.createPartsVector(t, e);
            return g.startGeometry(t), g.addParts(t, r), g.addType(t, o), g.endGeometry(t)
        }
        const a = g.createXyVector(t, r);
        let h, u;
        return n && (h = g.createZVector(t, n)), s && (u = g.createEndsVector(t, s)), g.startGeometry(t), u && g.addEnds(t, u), g.addXy(t, a), h && g.addZ(t, h), g.addType(t, o), g.endGeometry(t)
    }

    function F(e, r) {
        let n, s, i, o = r;
        if (o === t.GeometryType.Unknown && (o = x(e.getType())), o === t.GeometryType.MultiLineString) {
            e.getFlatCoordinates && (n = e.getFlatCoordinates());
            const t = e.getEnds();
            t.length > 1 && (s = t.map((t => t >> 1)))
        } else if (o === t.GeometryType.Polygon) {
            e.getFlatCoordinates && (n = e.getFlatCoordinates());
            const t = e.getEnds();
            t.length > 1 && (s = t.map((t => t >> 1)))
        } else if (o === t.GeometryType.MultiPolygon) {
            i = e.getPolygons().map((e => F(e, t.GeometryType.Polygon)))
        } else e.getFlatCoordinates && (n = e.getFlatCoordinates());
        return {xy: n, ends: s, type: o, parts: i}
    }

    function x(e) {
        if (!e) return t.GeometryType.Unknown;
    ...
    function T(e, r, n) {
        const s = n.columns, i = new h;
        let o = 0, a = 1024, u = new Uint8Array(a), c = new DataView(u.buffer);
        const l = function (t) {
            if (o + t < a) return;
            a *= 2;
            const e = new Uint8Array(a);
            e.set(u), u = e, c = new DataView(u.buffer, o)
        };
        if (s) for (let e = 0; e < s.length; e++) {
            const n = s[e], i = r[n.name];
            if (null !== i) switch (c.setUint16(o, e, !0), o += 2, n.type) {
                case t.ColumnType.Bool:
                    l(1), c.setUint8(o, i), o += 1;
                    break;
                case t.ColumnType.Short:
                    l(2), c.setInt16(o, i, !0), o += 2;
                    break;
                case t.ColumnType.UShort:
                    l(2), c.setUint16(o, i, !0), o += 2;
                    break;
                case t.ColumnType.Int:
                    l(4), c.setInt32(o, i, !0), o += 4;
                    break;
                case t.ColumnType.UInt:
                    l(4), c.setUint32(o, i, !0), o += 4;
                    break;
                case t.ColumnType.Long:
                    l(8), c.setBigInt64(o, BigInt(i), !0), o += 8;
                    break;
                case t.ColumnType.Double:
                    l(8), c.setFloat64(o, i, !0), o += 8;
                    break;
                case t.ColumnType.DateTime:
                case t.ColumnType.String: {
                    const t = P.encode(i);
                    l(4), c.setUint32(o, t.length, !0), o += 4, l(t.length), u.set(t, o), o += t.length;
                    break
                }
                default:
        ...
        let b = null;
        o > 0 && (b = w.createPropertiesVector(i, u.slice(0, o)));
        const f = I(i, e);
        w.startFeature(i), w.addGeometry(i, f), b && w.addProperties(i, b);
        const d = w.endFeature(i);
        return i.finishSizePrefixed(d), i.asUint8Array()
    }
    ...
    function V(t, e, r) {
        ...
        function a(t, e) {
            try {
                (r = s[t](e)).value instanceof E ? Promise.resolve(r.value.v).then(h, u) : c(i[0][2], r)
            } catch (t) {
                c(i[0][3], t)
            }
            var r
    ...
    function L(t, e) {
        ...
        return Promise.resolve(e).then((function (e) {
            return !r && t.state >= 4 ? N(t).then((function (t) {
    ...
    function k(t, e) {
        ...
        if (!(t.state >= 2)) if (t.state = 2, t.onnext(), t.onstop(), null == t.err && (t.err = e), 0 !== t.pushes.length || void 0 !== t.buffer && !t.buffer.empty) try {
            for (var s = S(t.pushes), i = s.next(); !i.done; i = s.next()) {
                i.value.resolve()
            }
        } catch (t) {
            r = {error: t}
    ...
    function G(t) {
        var e, r;
        if (!(t.state >= 3)) {
            t.state < 2 && k(t), t.state = 3, t.buffer = void 0;
            try {
                for (var n = S(t.nexts), s = n.next(); !s.done; s = n.next()) {
                    var i = s.value, o = void 0 === t.pending ? N(t) : t.pending.then((function () {
                        return N(t)
                    }));
                    i.resolve(L(t, o))
                }
    ...
    function j(t) {
        t.state >= 4 || (t.state < 3 && G(t), t.state = 4)
    }

    function M(t, e) {
        if (B(e), t.pushes.length >= R) throw new A("No more than 1024 pending calls to push are allowed on a single repeater.");
        ...
        (n = n.catch((function (e) {
            t.state < 2 && (t.err = e), j(t)
        })), t.nexts.length) ? (t.nexts.shift().resolve(L(t, n)), r = t.nexts.length ? Promise.resolve(t.nexts[0].value) : new Promise((function (e) {
            return t.onnext = e
    ...
    function $(t) {
        if (!(t.state >= 1)) {
            t.state = 1;
            var e = M.bind(null, t), r = function (t) {
                var e = k.bind(null, t), r = new Promise((function (e) {
                    return t.onstop = e
                }));
    ...
    var z, D = new WeakMap, H = function () {
        function t(t, e) {
            D.set(this, {
                executor: t,
                buffer: e,
        ...
        return t.prototype.next = function (t) {
            ...
            if (e.nexts.length >= R) throw new A("No more than 1024 pending calls to next are allowed on a single repeater.");
            if (e.state <= 0 && $(e), e.onnext(t), void 0 !== e.buffer && !e.buffer.empty) {
                var r = L(e, e.buffer.remove());
                if (e.pushes.length) {
            ...
            if (e.pushes.length) {
                ...
                return e.onnext = s.resolve, L(e, s.value)
            }
            return e.state >= 2 ? (G(e), L(e, N(e))) : new Promise((function (r) {
            ...
            var e = D.get(this);
            if (void 0 === e) throw new Error("WeakMap error");
            return G(e), e.execution = Promise.resolve(e.execution).then((function () {
                return t
            })), L(e, N(e))
        }, t.prototype.throw = function (t) {
            var e = D.get(this);
            if (void 0 === e) throw new Error("WeakMap error");
            return e.state <= 0 || e.state >= 2 || void 0 !== e.buffer && !e.buffer.empty ? (G(e), null == e.err && (e.err = t), L(e, N(e))) : this.next(Promise.reject(t))
        }, t.prototype[Symbol.asyncIterator] = function () {
            return this
        }, t.race = Z, t.merge = X, t.zip = Y, t.latest = K, t
    }();
            ...
            null != t && "function" == typeof t[Symbol.asyncIterator] ? s.push(t[Symbol.asyncIterator]()) : null != t && "function" == typeof t[Symbol.iterator] ? s.push(t[Symbol.iterator]()) : s.push(function () {
                return V(this, arguments, (function () {
                    return O(this, (function (r) {
                        switch (r.label) {
                            case 0:
                                return e.yieldValues ? [4, E(t)] : [3, 3];
                            case 1:
                                return [4, r.sent()];
                            case 2:
                                r.sent(), r.label = 3;
                            case 3:
                                return e.returnValues ? [4, E(t)] : [3, 5];
                            case 4:
                                return [2, r.sent()];
                            case 5:
                                return [2]
    ...
    function Z(t) {
        var e = this, r = W(t, {returnValues: !0});
                                ...
                                return O(this, (function (f) {
                                    switch (f.label) {
                                        case 0:
                                            s = a;
                                            try {
                                                for (l = void 0, h = S(r), u = h.next(); !u.done; u = h.next()) c = u.value, Promise.resolve(c.next()).then((function (t) {
    ...
    function X(t) {
        var e = this, r = W(t, {yieldValues: !0});
        return new H((function (t, n) {
            return U(e, void 0, void 0, (function () {
                var e, s, i, o = this;
    ...
    function K(t) {
        var e = this, r = W(t, {yieldValues: !0, returnValues: !0});
        return new H((function (t, n) {
            return U(e, void 0, void 0, (function () {
                    ...
                    switch (u.label) {
                        case 0:
                            ...
                            s = [], i = !1, n.then((function () {
                                ...
                                e();
                                try {
                                    for (var n = S(s), o = n.next(); !o.done; o = n.next()) {
                                        (0, o.value)()
                                    }
                                } catch (e) {
                                    t = {error: e}
                        ...
                        case 3:
                            return u.sent(), [4, Promise.all(r.map((function (e, r) {
                                return U(h, void 0, void 0, (function () {
                                    var h;
                                    return O(this, (function (u) {
                                        switch (u.label) {
                                            case 0:
    ...
    async function* et(t, e, r, n) {
        ...
        Q.info(`tree items: ${t}, nodeSize: ${e}`);
        ...
        for (Q.debug(`starting stream search with queue: ${l}, numItems: ${t}, nodeSize: ${e}, levelBounds: ${u}`); 0 != l.length;) {
            const r = l.shift();
            Q.debug(`popped node: ${r}, queueLength: ${l.length}`);
            ...
            for (let e = b; e < _; e++) {
                ...
                if (i > g[n + 2]) continue;
                if (o > g[n + 3]) continue;
                const u = w[8 + (n << 1)], d = rt(w[9 + (n << 1)], u);
                if (f) {
                    const r = (() => {
                        if (e < t - 1) {
                            const t = 5 * (e - b + 1), r = w[8 + (t << 1)];
                            return rt(w[9 + (t << 1)], r) - d
                        }
                        return null
                    })();
                    yield[d, e - c, r];
                ...
                const _ = J.global.extraRequestThreshold() / 40, p = l[l.length - 1];
                if (void 0 !== p && p.level() == r.level() - 1 && d < p.endNode() + _) {
                    Q.debug(`Merging "nodeRange" request into existing range: ${p}, newOffset: ${p.endNode()} -> ${d}`), p.extendEndNodeToNewOffset(d);
                    continue
                }
                const y = (() => {
                    const t = r.level() - 1;
                ...
                void 0 !== p && p.level() == y.level() ? Q.info(`Same level, but too far away. Pushing new request at offset: ${d} rather than merging with distant ${p}`) : Q.info(`Pushing new level for ${y} onto queue with nearestNodeRange: ${p} since there's not already a range for this level.`), l.push(y)
            }
        }
    }
    ...
    const nt = new Uint8Array([102, 103, 98, 3, 102, 103, 98, 0]);
    ...
    class st {
        ...
        static async open(t) {
            ...
            Q.debug(`fetching header. minReqLength: ${n} (assumedHeaderLength: 2024, assumedIndexLength: ${r})`);
            {
                const t = new Uint8Array(await e.getRange(0, 8, n, "header"));
                if (!t.subarray(0, 3).every(((t, e) => nt[e] === t))) throw Q.error(`bytes: ${t} != ${nt}`), new Error("Not a FlatGeobuf file");
                Q.debug("magic bytes look good")
            }
            let s;
            {
                ...
                Q.debug(`headerLength: ${s}`)
            }
            const i = await e.getRange(12, s, n, "header"), o = new a(new Uint8Array(i)), h = v.fromByteBuffer(o),
                u = tt(h.featuresCount, h.indexNodeSize);
            return Q.debug("completed: opening http reader"), new st(e, h, s, u)
        }
        ...
        async* selectBbox(t) {
            ...
            let i = [];
            for await(const e of et(this.header.featuresCount, this.header.indexNodeSize, t, n)) {
                const [t, ,] = e;
                let [, , r] = e;
                if (!r) {
                    Q.info("final feature");
                    r = J.global.extraRequestThreshold()
                }
                if (0 == i.length) {
                    i.push([t, r]);
                    continue
                ...
                o > J.global.extraRequestThreshold() && (Q.info(`Pushing new feature batch, since gap ${o} was too large`), s.push(i), i = []), i.push([t, r])
            }
        ...
        lengthBeforeTree() {
            return nt.length + 4 + this.headerLength
        }
        ...
        async readFeature(t, e, r) {
            ...
            const i = await t.getRange(n + 4, s, r, "feature data"), o = new Uint8Array(i), h = new Uint8Array(s + 4);
            h.set(o, 4);
            const u = new a(h);
            return u.setPosition(4), w.getRootAsFeature(u)
        }
    }

    class it {
        constructor(t) {
            this.bytesEverUsed = 0, this.bytesEverFetched = 0, this.buffer = new ArrayBuffer(0), this.head = 0, this.httpClient = "string" == typeof t ? new ot(t) : t
        }
        ...
        async getRange(t, e, r, n) {
            ...
            return this.bytesEverFetched += o, Q.debug(`requesting for new Range: ${t}-${t + e - 1}`), this.buffer = await this.httpClient.getRange(t, o, n), this.head = t, this.buffer.slice(0, e)
        }

        logUsage(t) {
            const e = t.split(" ")[0], r = this.bytesEverUsed, n = this.bytesEverFetched, s = (100 * r / n).toFixed(2);
            Q.info(`${e} bytes used/requested: ${r} / ${n} = ${s}%`)
        }
    }
    ...
    class ot {
        ...
        async getRange(t, e, r) {
            ...
            Q.info(`request: #${this.requestsEverMade}, purpose: ${r}), bytes: (this_request: ${e}, ever: ${this.bytesEverRequested}), Range: ${n}`);
            return (await fetch(this.url, {headers: {Range: n}})).arrayBuffer()
        }
    }

    async function* at(t, e, r) {
        const n = "function" == typeof (s = t).slice ? s : new f("function" == typeof s.read ? s : s.getReader());
        var s;
        const i = async t => await n.slice(t);
        let o = new Uint8Array(await i(8));
        if (!o.subarray(0, 3).every(((t, e) => nt[e] === t))) throw new Error("Not a FlatGeobuf file");
        o = new Uint8Array(await i(4));
        let h = new a(o);
        const u = h.readUint32(0);
        o = new Uint8Array(await i(u)), h = new a(o);
        const c = v.fromByteBuffer(h);
        r && r(c);
        const {indexNodeSize: l, featuresCount: b} = c;
        if (l > 0) {
            const t = tt(b, l);
            await i(t)
        }
        let d;
        for (; d = await ht(i, c, e);) yield d
    }
    ...
    async function ht(t, e, r) {
        ...
        o.set(n, 4), s = new a(o), s.setPosition(4);
        return r(w.getRootAsFeature(s), e)
    }

    t.deserialize = function (t, e, r) {
        return t instanceof Uint8Array ? function (t, e, r) {
            if (!t.subarray(0, 3).every(((t, e) => nt[e] === t))) throw new Error("Not a FlatGeobuf file");
            const n = new a(t), s = n.readUint32(nt.length);
            n.setPosition(nt.length + 4);
            const i = v.fromByteBuffer(n);
            r && r(i);
            let o = nt.length + 4 + s;
            const {indexNodeSize: h, featuresCount: u} = i;
            h > 0 && (o += tt(u, h));
            const c = [];
            for (; o < n.capacity();) {
                const t = n.readUint32(o);
                n.setPosition(o + 4);
                const r = w.getRootAsFeature(n);
                c.push(e(r, i)), o += 4 + t
            }
            return c
        }(t, e) : t instanceof ReadableStream ? at(t, e) : async function* (t, e, r, n) {
            const s = await st.open(t);
            Q.debug("opened reader"), n && n(s.header);
            for await(const t of s.selectBbox(e)) yield r(t, s.header)
        }(t, r, e)
    }, t.serialize = function (e) {
        const r = function (e) {
            const r = e[0], n = r.getProperties ? r.getProperties() : {};
            let s = null;
            n && (s = Object.keys(n).filter((t => "geometry" !== t)).map((e => new d(e, function (e) {
                if ("boolean" == typeof e) return t.ColumnType.Bool;
                if ("number" == typeof e) return e % 1 == 0 ? t.ColumnType.Int : t.ColumnType.Double;
                if ("string" == typeof e) return t.ColumnType.String;
                if (null === e) return t.ColumnType.String;
                throw new Error(`Unknown type (value '${e}')`)
            }(n[e]), null, null, -1, -1, -1, !0, !1, !1))));
            const i = function (e) {
                let r;
                for (const s of e) {
                    if (r === t.GeometryType.Unknown) break;
                    const e = (n = s).getGeometry ? x(n.getGeometry().getType()) : x(n.geometry.type);
                    void 0 === r ? r = e : r !== e && (r = t.GeometryType.Unknown)
                }
                var n;
                if (void 0 === r) throw new Error("Could not infer geometry type for collection of features.");
                return r
            }(e);
            return new v(i, s, e.length, 0, null, null, null, null)
        }(e), n = function (t) {
            const e = new h;
            let r = null;
            t.columns && (r = y.createColumnsVector(e, t.columns.map((t => function (t, e) {
                const r = t.createString(e.name);
                return _.startColumn(t), _.addName(t, r), _.addType(t, e.type), _.endColumn(t)
            }(e, t)))));
            const n = e.createString("L1");
            y.startHeader(e), y.addFeaturesCount(e, new i(t.featuresCount, 0)), y.addGeometryType(e, t.geometryType), y.addIndexNodeSize(e, 0), r && y.addColumns(e, r);
            y.addName(e, n);
            const s = y.endHeader(e);
            ...
            return T(F(t.getGeometry(), r.geometryType), t.getProperties(), r)
        })), o = s.map((t => t.length)).reduce(((t, e) => t + e)), a = new Uint8Array(nt.length + n.length + o);
        a.set(n, nt.length);
        let u = nt.length + n.length;
        for (const t of s) a.set(t, u), u += t.length;
        return a.set(nt), a
    }, Object.defineProperty(t, "__esModule", {value: !0})
}));
//# sourceMappingURL=flatgeobuf.min.js.map
