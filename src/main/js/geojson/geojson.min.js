...
!function (t, e) {
    ...
    class e {
        constructor(t, e, r, n, s, i, o, a, h, c) {
            this.name = t, this.type = e, this.title = r, this.description = n, this.width = s, this.precision = i, this.scale = o, this.nullable = a, this.unique = h, this.primary_key = c
        }
    }
    ...
    const s = new Int32Array(2), i = new Float32Array(s.buffer), o = new Float64Array(s.buffer),
    ...
    class l {
        ...
        readFloat32(t) {
            return s[0] = this.readInt32(t), i[0]
        }

        readFloat64(t) {
            return s[a ? 0 : 1] = this.readInt32(t), s[a ? 1 : 0] = this.readInt32(t + 4), o[0]
        }
        ...
        writeFloat32(t, e) {
            i[0] = e, this.writeInt32(t, s[0])
        }

        writeFloat64(t, e) {
            o[0] = e, this.writeInt32(t, s[a ? 0 : 1]), this.writeInt32(t + 4, s[a ? 1 : 0])
        }
        ...
        __string(t, e) {
            ...
            let n = "", s = 0;
            if (t += 4, e === c.UTF8_BYTES) return this.bytes_.subarray(t, t + r);
            for (; s < r;) {
                let e;
    ...
    class b {
        constructor(t) {
            let e;
            this.minalign = 1, this.vtable = null, this.vtable_in_use = 0, this.isNested = !1, this.object_start = 0, this.vtables = [], this.vector_num_elems = 0, this.force_defaults = !1, this.string_maps = null, e = t || 1024, this.bb = l.allocate(e), this.space = e
        }
        ...
        prep(t, e) {
            ...
            for (; this.space < r + t + e;) {
                ...
                this.bb = b.growByteBuffer(this.bb), this.space += this.bb.capacity() - t
            }
            this.pad(r)
        }
    ...
    class f {
        ...
        type() {
            ...
            return t ? this.bb.readUint8(this.bb_pos + t) : r.Byte
        }
        ...
        static createColumn(t, e, r, n, s, i, o, a, h, c, u, l) {
            return f.startColumn(t), f.addName(t, e), f.addType(t, r), f.addTitle(t, n), f.addDescription(t, s), f.addWidth(t, i), f.addPrecision(t, o), f.addScale(t, a), f.addNullable(t, h), f.addUnique(t, c), f.addPrimaryKey(t, u), f.addMetadata(t, l), f.endColumn(t)
        }
    }
    ...
    class d {
        ...
        static getSizePrefixedRootAsCrs(t, e) {
            return t.setPosition(t.position() + 4), (e || new d).__init(t.readInt32(t.position()) + t.position(), t)
        }
        ...
        static createCrs(t, e, r, n, s, i, o) {
            return d.startCrs(t), d.addOrg(t, e), d.addCode(t, r), d.addName(t, n), d.addDescription(t, s), d.addWkt(t, i), d.addCodeString(t, o), d.endCrs(t)
        }
    }
    ...
    class _ {
        ...
        geometryType() {
            ...
            return t ? this.bb.readUint8(this.bb_pos + t) : u.Unknown
        }
        ...
        columns(t, e) {
            ...
            return r ? (e || new f).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : null
        }
        ...
        crs(t) {
            const e = this.bb.__offset(this.bb_pos, 24);
            return e ? (t || new d).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : null
        }
    ...
    class p {
        ...
        static fromByteBuffer(t) {
            const r = _.getRootAsHeader(t), s = r.featuresCount().toFloat64(), i = r.indexNodeSize(), o = [];
            for (let t = 0; t < r.columnsLength(); t++) {
                const n = r.columns(t);
                if (!n) throw new Error("Column unexpectedly missing");
                if (!n.name()) throw new Error("Column name unexpectedly missing");
                o.push(new e(n.name(), n.type(), n.title(), n.description(), n.width(), n.precision(), n.scale(), n.nullable(), n.unique(), n.primaryKey()))
            }
            const a = r.crs(),
                h = a ? new n(a.org(), a.code(), a.name(), a.description(), a.wkt(), a.codeString()) : null;
            return new p(r.geometryType(), o, s, i, h, r.title(), r.description(), r.metadata())
        }
    }
    ...
    class y {
        ...
        parts(t, e) {
            const r = this.bb.__offset(this.bb_pos, 18);
            return r ? (e || new y).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + r) + 4 * t), this.bb) : null
        }
        ...
        static createGeometry(t, e, r, n, s, i, o, a, h) {
            return y.startGeometry(t), y.addEnds(t, e), y.addXy(t, r), y.addZ(t, n), y.addM(t, s), y.addT(t, i), y.addTm(t, o), y.addType(t, a), y.addParts(t, h), y.endGeometry(t)
        }
    }
    ...
    function g(t, e) {
        ...
        if (i) {
            const e = i.map((e => g(t, e))), r = y.createPartsVector(t, e);
            return y.startGeometry(t), y.addParts(t, r), y.addType(t, o), y.endGeometry(t)
        }
        const a = y.createXyVector(t, r);
        let h, c;
        return n && (h = y.createZVector(t, n)), s && (c = y.createEndsVector(t, s)), y.startGeometry(t), c && y.addEnds(t, c), y.addXy(t, a), h && y.addZ(t, h), y.addType(t, o), y.endGeometry(t)
    }

    function w(t, e, r) {
        if (0 !== t.length) if (Array.isArray(t[0])) for (const n of t) w(n, e, r); else 2 === t.length ? e.push(...t) : (e.push(t[0], t[1]), r.push(t[2]))
    }
    ...
    function I(t) {
        ...
        switch (t.type) {
            ...
            case"Polygon": {
                const t = e;
                w(t, r, n), t.length > 1 && (s = t.map((t => a += t.length)));
                break
            }
            case"MultiPolygon":
                i = e.map((t => ({type: "Polygon", coordinates: t}))).map(I);
                break;
            case"GeometryCollection":
                t.geometries && (i = t.geometries.map(I))
        }
        return {xy: r, z: n.length > 0 ? n : void 0, ends: s, type: o, parts: i}
    }

    function F(t, e, r) {
        if (!r || 0 === r.length) return [v(t, e)];
        let n = 0;
        const s = Array.from(r).map((e => t.slice(n, n = e << 1)));
        let i;
        return e && (n = 0, i = Array.from(r).map((t => e.slice(n, n = t)))), s.map(((t, e) => v(t, i ? i[e] : void 0)))
    }

    function x(t, e) {
        let r = e;
        if (r === u.Unknown && (r = t.type()), r === u.GeometryCollection) {
            const e = [];
            for (let r = 0; r < t.partsLength(); r++) {
                const n = t.parts(r), s = n.type();
                e.push(x(n, s))
            }
            return {type: u[r], geometries: e}
        }
        if (r === u.MultiPolygon) {
            const e = [];
            for (let r = 0; r < t.partsLength(); r++) e.push(x(t.parts(r), u.Polygon));
            return {type: u[r], coordinates: e.map((t => t.coordinates))}
        }
        const n = function (t, e) {
            const r = t.xyArray(), n = t.zArray();
            switch (e) {
                case u.Point: {
                    const t = Array.from(r);
                    return n && t.push(n[0]), t
                }
                case u.MultiPoint:
                case u.LineString:
                    return v(r, n);
                ...
                case u.Polygon:
                    return F(r, n, t.endsArray())
            }
        }(t, r);
        return {type: u[r], coordinates: n}
    }
    ...
    class U {
        ...
        geometry(t) {
            const e = this.bb.__offset(this.bb_pos, 4);
            return e ? (t || new y).__init(this.bb.__indirect(this.bb_pos + e), this.bb) : null
        }
        ...
        static createFeature(t, e, r, n) {
            return U.startFeature(t), U.addGeometry(t, e), U.addProperties(t, r), U.addColumns(t, n), U.endFeature(t)
        }
    }

    const P = new TextEncoder, O = new TextDecoder;

    function S(t, e, n) {
        const s = n.columns, i = new b;
        let o = 0, a = 1024, h = new Uint8Array(a), c = new DataView(h.buffer);
        const u = function (t) {
            if (o + t < a) return;
            a *= 2;
            const e = new Uint8Array(a);
            e.set(h), h = e, c = new DataView(h.buffer, o)
        };
        if (s) for (let t = 0; t < s.length; t++) {
            const n = s[t], i = e[n.name];
            if (null !== i) switch (c.setUint16(o, t, !0), o += 2, n.type) {
                case r.Bool:
                    u(1), c.setUint8(o, i), o += 1;
                    break;
                case r.Short:
                    u(2), c.setInt16(o, i, !0), o += 2;
                    break;
                case r.UShort:
                    u(2), c.setUint16(o, i, !0), o += 2;
                    break;
                case r.Int:
                    u(4), c.setInt32(o, i, !0), o += 4;
                    break;
                case r.UInt:
                    u(4), c.setUint32(o, i, !0), o += 4;
                    break;
                case r.Long:
                    u(8), c.setBigInt64(o, BigInt(i), !0), o += 8;
                    break;
                case r.Double:
                    u(8), c.setFloat64(o, i, !0), o += 8;
                    break;
                case r.DateTime:
                case r.String: {
                    const t = P.encode(i);
                    u(4), c.setUint32(o, t.length, !0), o += 4, u(t.length), h.set(t, o), o += t.length;
                    break
                }
                default:
        ...
        let l = null;
        o > 0 && (l = U.createPropertiesVector(i, h.slice(0, o)));
        const f = g(i, t);
        U.startFeature(i), U.addGeometry(i, f), l && U.addProperties(i, l);
        const d = U.endFeature(i);
        return i.finishSizePrefixed(d), i.asUint8Array()
    }

    function C(t, e) {
        const n = e.columns, s = {type: "Feature", geometry: x(t.geometry(), e.geometryType)};
        return n && n.length > 0 && (s.properties = function (t, e) {
            const n = {};
            if (!e || 0 === e.length) return n;
            const s = t.propertiesArray();
            if (!s) return n;
            const i = new DataView(s.buffer, s.byteOffset), o = t.propertiesLength();
            let a = 0;
            for (; a < o;) {
                const t = i.getUint16(a, !0);
                a += 2;
                const o = e[t], h = o.name;
                switch (o.type) {
                    case r.Bool:
                        n[h] = !!i.getUint8(a), a += 1;
                        break;
                    case r.Byte:
                        n[h] = i.getInt8(a), a += 1;
                        break;
                    case r.UByte:
                        ...
                        break;
                    case r.Short:
                        n[h] = i.getInt16(a, !0), a += 2;
                        break;
                    case r.UShort:
                        n[h] = i.getUint16(a, !0), a += 2;
                        break;
                    case r.Int:
                        n[h] = i.getInt32(a, !0), a += 4;
                        break;
                    case r.UInt:
                        n[h] = i.getUint32(a, !0), a += 4;
                        break;
                    case r.Long:
                        n[h] = Number(i.getBigInt64(a, !0)), a += 8;
                        break;
                    case r.ULong:
                        n[h] = Number(i.getBigUint64(a, !0)), a += 8;
                        break;
                    case r.Double:
                        n[h] = i.getFloat64(a, !0), a += 8;
                        break;
                    case r.DateTime:
                    case r.String: {
                        const t = i.getUint32(a, !0);
                        a += 4, n[h] = O.decode(s.subarray(a, a + t)), a += t;
                        break
                    }
                    default:
    ...
    function E(t) {
        this._source = t, this._array = A, this._index = 0
    }

    E.prototype.read = function () {
        var t = this, e = t._array.subarray(t._index);
        return t._source.read().then((function (r) {
            return t._array = A, t._index = 0, r.done ? e.length > 0 ? {done: !1, value: e} : {
                done: !0,
                value: void 0
            } : {done: !1, value: V(e, r.value)}
        }))
        ...
        return n.set(this._array.subarray(this._index)), function s() {
            return e._source.read().then((function (i) {
                return i.done ? (e._array = A, e._index = 0, r > 0 ? n.subarray(0, r) : null) : r + i.value.length >= t ? (e._array = i.value, e._index = t - r, n.set(i.value.subarray(0, t - r), r), n) : (n.set(i.value, r), r += i.value.length, s())
            }))
        }()
    ...
    function R(t, e, r) {
        ...
        function a(t, e) {
            try {
                (r = s[t](e)).value instanceof N ? Promise.resolve(r.value.v).then(h, c) : u(i[0][2], r)
            } catch (t) {
                u(i[0][3], t)
            }
            var r
    ...
    function M(t) {
        null != t && "function" == typeof t.then && t.then($, $)
    }
    ...
    function G(t, e) {
        ...
        return Promise.resolve(e).then((function (e) {
            return !r && t.state >= 4 ? z(t).then((function (t) {
    ...
    function D(t, e) {
        ...
        if (!(t.state >= 2)) if (t.state = 2, t.onnext(), t.onstop(), null == t.err && (t.err = e), 0 !== t.pushes.length || void 0 !== t.buffer && !t.buffer.empty) try {
            for (var s = L(t.pushes), i = s.next(); !i.done; i = s.next()) {
                i.value.resolve()
            }
        } catch (t) {
            r = {error: t}
    ...
    function H(t) {
        var e, r;
        if (!(t.state >= 3)) {
            t.state < 2 && D(t), t.state = 3, t.buffer = void 0;
            try {
                for (var n = L(t.nexts), s = n.next(); !s.done; s = n.next()) {
                    var i = s.value, o = void 0 === t.pending ? z(t) : t.pending.then((function () {
                        return z(t)
                    }));
                    i.resolve(G(t, o))
                }
    ...
    function W(t) {
        t.state >= 4 || (t.state < 3 && H(t), t.state = 4)
    }

    function Z(t, e) {
        if (M(e), t.pushes.length >= j) throw new q("No more than 1024 pending calls to push are allowed on a single repeater.");
        ...
        (n = n.catch((function (e) {
            t.state < 2 && (t.err = e), W(t)
        })), t.nexts.length) ? (t.nexts.shift().resolve(G(t, n)), r = t.nexts.length ? Promise.resolve(t.nexts[0].value) : new Promise((function (e) {
            return t.onnext = e
    ...
    function X(t) {
        if (!(t.state >= 1)) {
            t.state = 1;
            var e = Z.bind(null, t), r = function (t) {
                var e = D.bind(null, t), r = new Promise((function (e) {
                    return t.onstop = e
                }));
    ...
    var Y, K = new WeakMap, J = function () {
        function t(t, e) {
            K.set(this, {
                executor: t,
                buffer: e,
        ...
        return t.prototype.next = function (t) {
            ...
            if (e.nexts.length >= j) throw new q("No more than 1024 pending calls to next are allowed on a single repeater.");
            if (e.state <= 0 && X(e), e.onnext(t), void 0 !== e.buffer && !e.buffer.empty) {
                var r = G(e, e.buffer.remove());
                if (e.pushes.length) {
            ...
            if (e.pushes.length) {
                ...
                return e.onnext = s.resolve, G(e, s.value)
            }
            return e.state >= 2 ? (H(e), G(e, z(e))) : new Promise((function (r) {
            ...
            var e = K.get(this);
            if (void 0 === e) throw new Error("WeakMap error");
            return e.state <= 0 || e.state >= 2 || void 0 !== e.buffer && !e.buffer.empty ? (H(e), null == e.err && (e.err = t), G(e, z(e))) : this.next(Promise.reject(t))
        }, t.prototype[Symbol.asyncIterator] = function () {
            return this
        }, t.race = tt, t.merge = et, t.zip = rt, t.latest = nt, t
    }();
            ...
            null != t && "function" == typeof t[Symbol.asyncIterator] ? s.push(t[Symbol.asyncIterator]()) : null != t && "function" == typeof t[Symbol.iterator] ? s.push(t[Symbol.iterator]()) : s.push(function () {
                return R(this, arguments, (function () {
                    return k(this, (function (r) {
                        switch (r.label) {
                            case 0:
                                return e.yieldValues ? [4, N(t)] : [3, 3];
                            case 1:
                                return [4, r.sent()];
                            case 2:
                                r.sent(), r.label = 3;
                            case 3:
                                return e.returnValues ? [4, N(t)] : [3, 5];
                            case 4:
                                return [2, r.sent()];
                            case 5:
                                return [2]
    ...
    function tt(t) {
        var e = this, r = Q(t, {returnValues: !0});
            ...
            return B(e, void 0, void 0, (function () {
                ...
                return k(this, (function (c) {
                    switch (c.label) {
                        ...
                        case 1:
                            c.trys.push([1, , 5, 7]), o = void 0, a = 0, h = function () {
                                var s, h, c, u, l, b;
                                return k(this, (function (f) {
                                    switch (f.label) {
                                        case 0:
                                            s = a;
                                            try {
                                                for (l = void 0, h = L(r), c = h.next(); !c.done; c = h.next()) u = c.value, Promise.resolve(u.next()).then((function (t) {
    ...
    function et(t) {
        var e = this, r = Q(t, {yieldValues: !0});
        return new J((function (t, n) {
            return B(e, void 0, void 0, (function () {
                var e, s, i, o = this;
                    ...
                    switch (a.label) {
                        case 0:
                            ...
                            e = [], s = !1, n.then((function () {
                                ...
                                s = !0;
                                try {
                                    for (var n = L(e), i = n.next(); !i.done; i = n.next()) {
                                        (0, i.value)()
                                    }
                                } catch (e) {
                                    t = {error: e}
    ...
    function nt(t) {
        var e = this, r = Q(t, {yieldValues: !0, returnValues: !0});
        return new J((function (t, n) {
            return B(e, void 0, void 0, (function () {
                    ...
                    switch (c.label) {
                        case 0:
                            ...
                            s = [], i = !1, n.then((function () {
                                ...
                                e();
                                try {
                                    for (var n = L(s), o = n.next(); !o.done; o = n.next()) {
                                        (0, o.value)()
                                    }
                                } catch (e) {
                                    t = {error: e}
                        ...
                        case 1:
                            return c.trys.push([1, , 5, 7]), Promise.all(r.map((function (t) {
                                return t.next()
                            }))).then((function (t) {
                                return e(t)
                            }), (function (t) {
                        ...
                        case 2:
                            return void 0 === (o = c.sent()) ? [2] : (a = o.map((function (t) {
                                return t.value
                            })), o.every((function (t) {
                                return t.done
                            })) ? [2, a] : [4, t(a.slice())]);
                        case 3:
                            return c.sent(), [4, Promise.all(r.map((function (e, r) {
                                return B(h, void 0, void 0, (function () {
                                    ...
                                    return k(this, (function (c) {
                                        switch (c.label) {
                                            ...
                                            case 2:
                                                return void 0 === (h = c.sent()) ? [2, o[r].value] : h.done ? [2, h.value] : (a[r] = h.value, [4, t(a.slice())]);
                                            case 3:
                                                return c.sent(), [3, 1];
                                            case 4:
                                                return [2]
    ...
    async function* at(t, e, r, n) {
        ...
        it.info(`tree items: ${t}, nodeSize: ${e}`);
        ...
        for (it.debug(`starting stream search with queue: ${l}, numItems: ${t}, nodeSize: ${e}, levelBounds: ${c}`); 0 != l.length;) {
            const r = l.shift();
            it.debug(`popped node: ${r}, queueLength: ${l.length}`);
            const b = r.startNode(), f = b >= u, [, d] = c[r.level()], _ = Math.min(r.endNode() + e, d), p = _ - b,
            ...
            for (let e = b; e < _; e++) {
                ...
                if (i > g[n + 2]) continue;
                if (o > g[n + 3]) continue;
                const c = w[8 + (n << 1)], d = ht(w[9 + (n << 1)], c);
                if (f) {
                    const r = (() => {
                        if (e < t - 1) {
                            const t = 5 * (e - b + 1), r = w[8 + (t << 1)];
                            return ht(w[9 + (t << 1)], r) - d
                        }
                        return null
                    })();
                    yield[d, e - u, r];
                ...
                const _ = st.global.extraRequestThreshold() / 40, p = l[l.length - 1];
                if (void 0 !== p && p.level() == r.level() - 1 && d < p.endNode() + _) {
                    it.debug(`Merging "nodeRange" request into existing range: ${p}, newOffset: ${p.endNode()} -> ${d}`), p.extendEndNodeToNewOffset(d);
                    continue
                }
                const y = (() => {
                    const t = r.level() - 1;
                ...
                void 0 !== p && p.level() == y.level() ? it.info(`Same level, but too far away. Pushing new request at offset: ${d} rather than merging with distant ${p}`) : it.info(`Pushing new level for ${y} onto queue with nearestNodeRange: ${p} since there's not already a range for this level.`), l.push(y)
            }
        }
    }
    ...
    class ut {
        ...
        static async open(t) {
            ...
            it.debug(`fetching header. minReqLength: ${n} (assumedHeaderLength: 2024, assumedIndexLength: ${r})`);
            {
                const t = new Uint8Array(await e.getRange(0, 8, n, "header"));
                if (!t.subarray(0, 3).every(((t, e) => ct[e] === t))) throw it.error(`bytes: ${t} != ${ct}`), new Error("Not a FlatGeobuf file");
                it.debug("magic bytes look good")
            }
            let s;
            {
                ...
                it.debug(`headerLength: ${s}`)
            }
            const i = await e.getRange(12, s, n, "header"), o = new l(new Uint8Array(i)), a = p.fromByteBuffer(o),
                h = ot(a.featuresCount, a.indexNodeSize);
            return it.debug("completed: opening http reader"), new ut(e, a, s, h)
        }
        ...
        async* selectBbox(t) {
            ...
            let i = [];
            for await(const e of at(this.header.featuresCount, this.header.indexNodeSize, t, n)) {
                const [t, ,] = e;
                let [, , r] = e;
                if (!r) {
                    it.info("final feature");
                    r = st.global.extraRequestThreshold()
                }
                if (0 == i.length) {
                    i.push([t, r]);
                    continue
                ...
                o > st.global.extraRequestThreshold() && (it.info(`Pushing new feature batch, since gap ${o} was too large`), s.push(i), i = []), i.push([t, r])
            }
        ...
        buildFeatureClient() {
            return new lt(this.headerClient.httpClient)
        }
        ...
        async readFeature(t, e, r) {
            ...
            a.set(o, 4);
            const h = new l(a);
            return h.setPosition(4), U.getRootAsFeature(h)
        }
    }

    class lt {
        constructor(t) {
            this.bytesEverUsed = 0, this.bytesEverFetched = 0, this.buffer = new ArrayBuffer(0), this.head = 0, this.httpClient = "string" == typeof t ? new bt(t) : t
        }
        ...
        async getRange(t, e, r, n) {
            ...
            return this.bytesEverFetched += o, it.debug(`requesting for new Range: ${t}-${t + e - 1}`), this.buffer = await this.httpClient.getRange(t, o, n), this.head = t, this.buffer.slice(0, e)
        }

        logUsage(t) {
            const e = t.split(" ")[0], r = this.bytesEverUsed, n = this.bytesEverFetched, s = (100 * r / n).toFixed(2);
            it.info(`${e} bytes used/requested: ${r} / ${n} = ${s}%`)
        }
    }
    ...
    class bt {
        ...
        async getRange(t, e, r) {
            ...
            it.info(`request: #${this.requestsEverMade}, purpose: ${r}), bytes: (this_request: ${e}, ever: ${this.bytesEverRequested}), Range: ${n}`);
            return (await fetch(this.url, {headers: {Range: n}})).arrayBuffer()
        }
    }

    async function* ft(t, e, r) {
        const n = "function" == typeof (s = t).slice ? s : new E("function" == typeof s.read ? s : s.getReader());
        var s;
        ...
        o = new Uint8Array(await i(h)), a = new l(o);
        const c = p.fromByteBuffer(a);
        r && r(c);
        const {indexNodeSize: u, featuresCount: b} = c;
        if (u > 0) {
            const t = ot(b, u);
            await i(t)
        }
        let f;
        for (; f = await dt(i, c, e);) yield f
    }
    ...
    async function dt(t, e, r) {
        ...
        o.set(n, 4), s = new l(o), s.setPosition(4);
        return r(U.getRootAsFeature(s), e)
    }

    function _t(t) {
        const e = new b;
        let r = null;
        t.columns && (r = _.createColumnsVector(e, t.columns.map((t => function (t, e) {
            const r = t.createString(e.name);
            return f.startColumn(t), f.addName(t, r), f.addType(t, e.type), f.endColumn(t)
        }(e, t)))));
        const n = e.createString("L1");
        _.startHeader(e), _.addFeaturesCount(e, new h(t.featuresCount, 0)), _.addGeometryType(e, t.geometryType), _.addIndexNodeSize(e, 0), r && _.addColumns(e, r), _.addName(e, n);
        const s = _.endHeader(e);
        return e.finishSizePrefixed(s), e.asUint8Array()
    }

    function pt(t) {
        const n = function (t) {
                const n = t.features[0].properties;
                let s = null;
                n && (s = Object.keys(n).map((t => new e(t, function (t) {
                    if ("boolean" == typeof t) return r.Bool;
                    if ("number" == typeof t) return t % 1 == 0 ? r.Int : r.Double;
                    if ("string" == typeof t) return r.String;
                    if (null === t) return r.String;
                    throw new Error(`Unknown type (value '${t}')`)
                }(n[t]), null, null, -1, -1, -1, !0, !1, !1))));
                const i = function (t) {
                    let e;
                    for (const n of t) {
                        if (e === u.Unknown) break;
                        const t = (r = n).getGeometry ? m(r.getGeometry().getType()) : m(r.geometry.type);
                        void 0 === e ? e = t : e !== t && (e = u.Unknown)
                    }
                    var r;
                    if (void 0 === e) throw new Error("Could not infer geometry type for collection of features.");
                    return e
                }(t.features);
                return new p(i, s, t.features.length, 0, null, null, null, null)
            }(t), s = _t(n), i = t.features.map((t => S(I(t.geometry), t.properties, n))),
            o = i.map((t => t.length)).reduce(((t, e) => t + e)), a = new Uint8Array(ct.length + s.length + o);
        a.set(s, ct.length);
        let h = ct.length + s.length;
        for (const t of i) a.set(t, h), h += t.length;
        return a.set(ct), a
    }
    ...
    function yt(t, e) {
        const r = function (t, e, r) {
            ...
            const n = new l(t), s = n.readUint32(ct.length);
            n.setPosition(ct.length + 4);
            const i = p.fromByteBuffer(n);
            r && r(i);
            let o = ct.length + 4 + s;
    ...
    function gt(t, e, r) {
        return async function* (t, e, r, n) {
            ...
            it.debug("opened reader"), n && n(s.header);
            for await(const t of s.selectBbox(e)) yield r(t, s.header)
        }(t, e, C, r)
    }

    t.deserialize = function (t, e, r) {
        return t instanceof Uint8Array ? yt(t, r) : t instanceof ReadableStream ? function (t, e) {
            return ft(t, C, e)
        }(t, r) : gt(t, e, r)
